...
| **更新日志** | v1.3.0 当前版本完整更新内容 | [`docs/更新日志-v1.3.0.md`](./更新日志-v1.3.0.md) |
...
- `更新日志.md` — 全版本历史（根目录）
- `docs/更新日志-v1.3.0.md` — **v1.3.0 当前版本**（Tauri 迁移 + AI 增强）
...
旧版本安装包已清理，仅保留当前版本：
- `src-tauri/target/release/bundle/nsis/Storyloom_1.3.0_x64-setup.exe` + `.sig`
