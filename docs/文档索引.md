...
| **更新日志** | **v1.4.0 当前版本**（美术架构升级） | [`docs/更新日志-v1.4.0.md`](./更新日志-v1.4.0.md) |
...
- `更新日志.md` — 全版本历史（根目录）
- `docs/更新日志-v1.4.0.md` — **v1.4.0 当前版本**（美术架构升级）
...
- TypeScript 编译：0 错误
- 单元测试：193 / 193 通过
- 构建产物：`src-tauri/target/release/bundle/nsis/Storyloom_1.4.0_x64-setup.exe`（约 ~27MB，Tauri 产物）
- 签名文件：`src-tauri/target/release/bundle/nsis/Storyloom_1.4.0_x64-setup.exe.sig`
...
旧版本安装包已清理，仅保留当前版本：
- `src-tauri/target/release/bundle/nsis/Storyloom_1.4.0_x64-setup.exe` + `.sig`
