...
>(({ className, children, ...props }, ref) => {
  // 当调用者传入 flex/grid 布局时，不应用默认的 grid 布局
  const hasCustomLayout = className?.includes('flex') || className?.includes('grid');
  const hasCustomSize = className?.includes('max-w-') || className?.includes('w-');
  return (
    <DialogPortal>
      <DialogOverlay />
