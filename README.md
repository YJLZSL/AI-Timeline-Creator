...
> 把时间织成故事 · Weave timelines into living stories

[![Version](https://img.shields.io/badge/version-v1.4.0-amber)](https://github.com/YJLZSL/Storyloom/releases/tag/v1.4.0)
...
**Storyloom（絮织）** 是一款面向视觉小说、长篇小说与剧本创作者的本地桌面创作工作台。以"织机"为隐喻，将时间线编织为立体的故事结构——角色、事件、伏笔、世界观在时间轴上经纬交织，最终可一键导出到主流 Visual Novel 引擎。
...
| 平台 | 文件 | 体积 |
|------|------|------|
| Windows (x64) | `Storyloom_1.4.0_x64-setup.exe` | ~27 MB |
...
| 📝 [`docs/更新日志-v1.4.0.md`](./docs/更新日志-v1.4.0.md) | **v1.4.0 当前版本**（美术架构升级） | 所有人 |
| 📝 [`更新日志.md`](./更新日志.md) | 全版本历史记录 | 所有人 |
