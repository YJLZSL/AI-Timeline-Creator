...
[![Version](https://img.shields.io/badge/version-v1.3.0-amber)](https://github.com/YJLZSL/Storyloom/releases/tag/v1.3.0)
...
| 平台 | 文件 | 体积 |
|------|------|------|
| Windows (x64) | `Storyloom_1.3.0_x64-setup.exe` | ~27 MB |
